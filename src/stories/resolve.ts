import type { MockedContext, MocksModule, ResolvedStory, Story, StoryMeta, Viewport } from '../types.js'

export function resolve_story({ story, shared_meta, mocks, is_page, default_page_viewports }: {
  story: Story<any>
